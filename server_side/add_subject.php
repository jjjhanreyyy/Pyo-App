...
if (isset($_POST['go_submit'])) {
	...
	$units=ucwords(addslashes($_POST['subject_unit']));
	$prerequisite=ucwords(addslashes($_POST['prerequisite']));

	$sql = "INSERT INTO tbl_subjects (subject_description,subject_code,units,prerequisite) VALUES('{$subject_description}','{$subject_code}','{$units}','{$prerequisite}')";
